...
const steps = [
  {
    ...
    description: 'Il cliente scansiona il QR code o paga direttamente con carta o smartphone.',
    time: '5 secondi',
  ...
  },
  {
    ...
    time: 'Uso flessibile',
    details: ['Qualsiasi stazione', 'Senza vincoli rigidi', 'Flessibilità totale'],
  },
];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div ref={titleRef} className="text-center mb-20">
            ...
            <h2 className="reveal-item text-4xl sm:text-5xl lg:text-6xl font-sora font-bold text-brand-white mb-6">
              Facile per i tuoi clienti. <span className="text-gradient">Immediato per il tuo business</span>
            </h2>
            <p className="reveal-item text-lg text-brand-gray max-w-2xl mx-auto">
              Tre passaggi. Zero complicazioni. Il cliente noleggia in pochi secondi, senza app.
            </p>
          </div>
