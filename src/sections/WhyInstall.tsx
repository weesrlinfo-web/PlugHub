...
const benefits = [
  {
    ...
    description: 'Nessun costo di installazione o gestione. Pensiamo a tutto noi.',
    highlight: '100% FREE',
    color: '#2EE9FF',
  },
  {
    ...
    description: 'Lo staff non deve intervenire. Il servizio è completamente automatico.',
    highlight: '0 MIN',
    color: '#41A3CF',
  },
  {
    icon: TrendingUp,
    title: 'Clienti più a lungo nel locale',
    description: 'I clienti tendono a restare più a lungo mentre ricaricano, aumentando le occasioni di consumo.',
    highlight: 'LOVE',
    color: '#2EE9FF',
  },
  {
    ...
    description: 'Offri un servizio utile che i clienti apprezzano e ricordano.',
    highlight: 'LOVE',
    color: '#41A3CF',
  },
  {
    icon: Ban,
    title: 'Meno richieste allo staff',
    description: 'Riduci le richieste dei clienti e lascia lo staff concentrato sul servizio.',
    highlight: 'FOCUS',
    color: '#2EE9FF',
  },
  {
    ...
    description: 'Manutenzione e assistenza incluse, con sostituzione rapida in caso di problemi.',
    highlight: '24/7',
    color: '#41A3CF',
  },
];
