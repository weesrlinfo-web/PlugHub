...
const useCases = [
  {
    ...
    description: 'I clienti restano più a lungo mentre ricaricano, aumentando le occasioni di consumo.',
    stat: 'Più',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={titleRef} className="text-center mb-20">
            ...
            <h2 className="reveal-item text-4xl sm:text-5xl lg:text-6xl font-sora font-bold text-brand-white mb-6">
              Perfetto per <span className="text-gradient">ogni tipo di locale</span>
            </h2>
            <p className="reveal-item text-lg text-brand-gray max-w-2xl mx-auto">
              PlugHub si adatta a qualsiasi ambiente: dal bar alla palestra, fino a hotel ed eventi.
            </p>
          </div>
